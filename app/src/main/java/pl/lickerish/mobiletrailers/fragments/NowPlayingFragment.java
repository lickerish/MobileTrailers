...
public class NowPlayingFragment extends Fragment {
    ...
    private void setupView(View view) {
        ...
        adapter = new RecyclerViewAdapter(Collections.emptyList(), NowPlayingFragment.this.getActivity());
        recyclerView.setAdapter(adapter);
    }

    private void loadNextPage() {
        Call<TopRatedMovies> call = apiInterface.getNowPlayingMovies(API_KEY, "en-US", pageNumber);
